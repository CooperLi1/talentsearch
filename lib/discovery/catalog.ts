...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  },
  {
    ...
    officialHome: "https://developers.openalex.org/",
  },
  {
    key: "crossref",
  ...
  },
  {
    ...
    access: "official-api",
    defaultEnabled: false,
    description: "Public models, datasets, and apps with verified individual author profiles and metadata-only technical-depth signals.",
    officialHome: "https://huggingface.co/docs/hub/api",
  },
  {
    key: "olympiads",
    ...
    defaultEnabled: true,
    description: "Reviewed selectors for official result tables; the starter catalog includes IMO and IChO 2025.",
  ...
  },
  {
    ...
    officialHome: "https://www.societyforscience.org/regeneron-sts/",
    configTemplate: structuredTemplate("competition_result"),
  },
  {
    key: "fellowships",
    name: "Selective technical fellowships",
    category: "research",
    connector: "structured-results",
    access: "robots-aware-page",
    defaultEnabled: true,
    description: "Reviewed public cohort pages for selective technical and scientific fellowships.",
    officialHome: "https://www.hertzfoundation.org/hertz-fellowship/",
    configTemplate: structuredTemplate("competition_result"),
  },
  {
  ...
  },
  {
    ...
    configTemplate: { enabled: false, maxItems: 8, options: { maxQueries: 5, maxResults: 8 } },
  },
  {
    key: "linkedin",
    ...
    defaultEnabled: false,
    description: "Reviewed profile imports and separately approved profile access; LinkedIn pages are never scraped.",
