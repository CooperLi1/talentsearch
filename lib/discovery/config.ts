...
const configurationSchema = z.object({
  ...
  scoringWeights: z.object({
    ...
    activityVolume: z.number().min(0).max(1).default(.14),
    ...
    achievementQuality: .215,
    activityVolume: .14,
    trajectoryVelocity: .146,
    projectOriginality: .12,
    technicalComplexity: .129,
    networkProximity: .103,
    evidenceDiversity: .069,
    earlyness: .078,
  }),
});
...
export const VERIFIED_TECHNICAL_FEEDS = [
  ...
  "https://www.twilio.com/en-us/blog/feed",
  ...
  "https://medium.com/feed/indeed-engineering",
...
const defaults: Record<SourceKind, ConnectorSettings> = {
  ...
  "roster-page": { enabled: false, maxItems: 500, urls: [] },
