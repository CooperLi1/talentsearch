-- The v12 policy adds one bounded retry that replaces facts rejected by the
-- grounding verifier instead of publishing stale copy or looping forever.
  ...
  with substantive as (
    ...
    where candidates.workspace_id = p_workspace_id
      ...
      and (
        ...
        or candidates.brief_prompt_version is distinct from 'operator-v12'
      )
      and (
